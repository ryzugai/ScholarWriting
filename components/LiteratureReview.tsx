              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm flex flex-col">
                  ...
                  <div className="flex gap-3 mt-8">
                    ...
                    <a href={selectedCapture.paper.url} target="_blank" className="flex-1 text-center text-[10px] font-black bg-indigo-50 text-indigo-600 px-5 py-3 rounded-xl uppercase">Source</a>
                  </div>
                </div>
              </div>
            </div>
